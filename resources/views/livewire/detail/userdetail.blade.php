<div class="flex-col">
    <div wire:loading wire:target='image,formGenerate,save,changeProfileState,changePasswordState,profileFormGenerate,changePasswordFormGenerate,saveChangePassword'>
