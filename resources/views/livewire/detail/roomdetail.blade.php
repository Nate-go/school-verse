<div class="flex-col">
    <div wire:loading wire:target='image,formGenerate,save,changeTeacherState,changeStudentState,deleteSubjectTeacher,addSubjectTeacher,deleteStudent,addStudent'>
