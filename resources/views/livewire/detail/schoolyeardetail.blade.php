<div class="flex-col">
    <div wire:loading wire:target='formGenerate,save'>
            ...
            <div class="">
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="date" name="" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                            wire:model='startAt' placeholder="" />
                    </div>

                    <div class="md:col-span-2">
                        <label>End at</label>
                        <input type="date" name="" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                            wire:model='endAt' placeholder="" />
                    </div>
