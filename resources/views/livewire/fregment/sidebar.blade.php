<aside
        ...
        <div class="m-4">
            <ul class="mb-4 flex flex-col gap-1 text-base">
                ...
                <li><a class="" href="/statistic"><button
                            class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none  py-3 rounded-lg {{ $page === 'statistic' ? 'bg-gradient-to-tr from-blue-600 to-blue-400 text-white shadow-md shadow-blue-500/20 hover:shadow-lg hover:shadow-blue-500/40 active:opacity-[0.85]' : 'hover:bg-blue-300'}}  w-full flex items-center gap-4 px-4 capitalize">
                            <i class="fa-solid fa-chart-line"></i>
                            <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">
                                Statistic</p>
                        </button></a></li>

                @if (Auth::user()->role === $teacherRole or Auth::user()->role === $adminRole)
                ...
                @if (Auth::user()->role === $studentRole or Auth::user()->role === $adminRole)
