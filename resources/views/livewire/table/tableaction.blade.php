<div class='relative flex'>
    ...
    @if ($actionIsOpen)
        <div
            class="w-fit absolute top-6 right-6 bg-white min-w-[180px] p-3 border border-blue-gray-50 rounded-md shadow-lg shadow-blue-gray-500/10 font-sans text-sm font-normal text-blue-gray-500 overflow-auto focus:outline-none z-[999]">
            <ul>
