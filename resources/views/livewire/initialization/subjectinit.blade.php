<div class="flex-col">
    <div wire:loading wire:target='image,create,formGenerate,addAndNext'>
            ...
            <div class="">
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                            ...
                            <div class="grid grid-cols-1 gap-3">
                                <div class="shrink-0 col-span-1 flex items-center justify-center">
                                    <img id='preview_img' class="h-24 w-24 object-cover rounded-full"
                                        src="{{$image ? $image->temporaryUrl() : asset('storage/images/default-image.png')}}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input wire:model='coefficient' type="number" placeholder="" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" />
                    </div>

                    <div class="md:col-span-2">
                        <label>Number of lesson</label>
                        <input wire:model='numberOfLesson' type="number" placeholder="" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"/>
                    </div>
                </div>
