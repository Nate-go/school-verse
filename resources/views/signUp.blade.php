    ...
    <div class="relative min-h-screen w-full">
        ...
        <div
            ...
            <div
                ...
                <h3 class="block antialiased tracking-normal font-sans text-3xl font-semibold leading-snug text-white">Sign Up
                </h3>
            </div>
            <div class="p-6 flex flex-col gap-4">
                <div class="relative w-full min-w-[200px] h-11"><input
                ...
                <div class="-ml-2.5">
                    <div class="inline-flex items-center"><label
                        ...
                        </label><label class="text-gray-700 font-light select-none cursor-pointer mt-px" for="checkbox">I agree
            ...
            <div class="p-6 pt-0"><button
                ...
                <p class="antialiased font-sans text-sm font-light leading-normal text-inherit mt-6 flex justify-center">Already
                    have an account?<a href="#/auth/sign-in"><span
